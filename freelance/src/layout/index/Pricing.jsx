...
const Pricing = () => {
  return (
    <>
        ...
        <div className="absolute h-[36.5rem] w-full top-0 bg-gradient-to-r from-green-500 to-green-800 -z-10"></div>
                ...
                <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-8 lg:space-y-0 lg:items-center">
                    ...
                    <div className="group relative flex flex-col mx-auto w-full max-w-sm bg-white rounded-2xl shadow-2xl transition-all duration-300  p-8 xl:p-12  ">
                        <div className="border-b border-solid border-gray-200 pb-9 mb-9">
                            <div className="w-16 h-16 rounded-full bg-green-50 mx-auto flex justify-center items-center transition-all duration-300 group-hover:bg-green-600">
                            <svg className="w-6 h-6 text-green-600 transition-all duration-300 group-hover:text-white" viewBox="0 0 31 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <h3 className="font-manrope text-2xl font-bold my-7 text-center text-green-600">StarterPack - PAGE WEB UNIQUE</h3>
                        ...
                        <ul className="mb-12 space-y-6 text-left text-lg text-gray-600 group-hover:text-gray-900">
                            <li className="flex items-center space-x-3.5">
                                ...
                                <span>Functionnal Web Site</span>
                            </li>
                            <li className="flex items-center space-x-3.5">
                        ...
                        <a href="javascript:;"  className="py-2.5 px-5 bg-green-50 shadow-sm rounded-full transition-all duration-500 text-base text-green-600 font-semibold text-center w-fit mx-auto group-hover:bg-green-600 group-hover:text-white ">Purchase Plan</a>
                    ...
                    <div className="group relative flex flex-col mx-auto w-full max-w-sm bg-white rounded-2xl shadow-2xl transition-all duration-300  p-8 xl:p-12  ">
                        <div className="border-b border-solid border-gray-200 pb-9 mb-9">
                            <div className="w-16 h-16 rounded-full bg-green-50 mx-auto flex justify-center items-center transition-all duration-300 group-hover:bg-green-600">
                                ...
                                <svg className="w-6 h-6 text-green-600 transition-all duration-300 group-hover:text-white"  viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <h3 className="font-manrope text-2xl font-bold my-7 text-center text-green-600">Local Business Plan - SMALL WEB APPLICATION</h3>
                        <div className="flex items-center justify-center">
                            <span className="font-manrope text-4xl font-medium text-gray-900">£249</span>
                        </div>
                    </div>
                        <ul className="mb-12 space-y-6 text-left text-lg text-gray-600 group-hover:text-gray-900">
                            <li className="flex items-center space-x-3.5">
                            ...
                            <li className="flex items-center space-x-3.5">
                                <span className="w-1.5 h-1.5 rounded-full bg-green-600"></span>
                                <span>E-commerce Fonctionnality</span>
                            </li>
                            <li className="flex items-center space-x-3.5">
                                <span className="w-1.5 h-1.5 rounded-full bg-green-600"></span>
                                <span>Content Upload</span>
                  ...
                  <div className="group relative flex flex-col mx-auto w-full max-w-sm bg-white rounded-2xl shadow-2xl transition-all duration-300  p-8 xl:p-12  ">
                    ...
                    <h3 className="font-manrope text-2xl font-bold my-7 text-center text-green-600">Buisness Plan - PREMIUM WEB APPLICATION </h3>
                    <div className="flex items-center justify-center">
                        <span className="font-manrope text-4xl font-medium text-gray-900">$599</span>
                    </div>
                </div>
                    <ul className="mb-12 space-y-6 text-left text-lg text-gray-600 group-hover:text-gray-900">
                        <li className="flex items-center space-x-3.5">
                        ...
                        <li className="flex items-center space-x-3.5">
                            <span className="w-1.5 h-1.5 rounded-full bg-green-600"></span>
                            <span>Fully custom-designed website with advanced UI/UX design.</span>
                        </li>
                        <li className="flex items-center space-x-3.5">
                            <span className="w-1.5 h-1.5 rounded-full bg-green-600"></span>
                            <span>SEO Optimisation</span>
                        ...
                        <li className="flex items-center space-x-3.5">
                            <span className="w-1.5 h-1.5 rounded-full bg-green-600"></span>
                            <span>Full e-commerce functionality with unlimited products, payment gateway integration, and advanced features (e.g., customer management, detailed reporting).
                            </span>
                        </li>
                        <li className="flex items-center space-x-3.5">
                            <span className="w-1.5 h-1.5 rounded-full bg-green-600"></span>
                    ...
                    <a href=""  className="py-2.5 px-5 bg-green-50 shadow-sm rounded-full transition-all duration-500 text-base text-green-600 font-semibold text-center w-fit mx-auto group-hover:bg-green-600 group-hover:text-white ">Purchase Plan</a>
