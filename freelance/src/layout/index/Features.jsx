        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mb-14 text-center">
                ...
                <p className="text-lg font-normal text-gray-500 max-w-md md:max-w-2xl mx-auto">
                    Provides advanced features like Support & Maintenance, Free domain name for the first year, SEO optimizations.
                </p>
            </div>
            <div
                ...
                <div className="relative w-full text-center max-md:max-w-sm max-md:mx-auto group md:w-2/5 lg:w-1/4">
                    ...
                    <p className="text-sm font-normal text-gray-500">
                        Ongoing support and maintenance, including regular updates, backups, and troubleshooting.                    </p>
                </div>
                <div className="relative w-full text-center max-md:max-w-sm max-md:mx-auto group md:w-2/5 lg:w-1/4">
                    ...
                    <p className="text-sm font-normal text-gray-500">
                        Ensure the website is fully responsive and optimized for all devices (mobile, tablet, desktop).
                    </p>
                </div>
                <div className="relative w-full text-center max-md:max-w-sm max-md:mx-auto group md:w-2/5 lg:w-1/4">
                    ...
                    <p className="text-sm font-normal text-gray-500">
                        Integration with Google Analytics and custom reporting to track website performance and user behavior.
                    </p>
                </div>
                <div className="relative w-full text-center max-md:max-w-sm max-md:mx-auto group md:w-2/5 lg:w-1/4">
                    ...
                    <p className="text-sm font-normal text-gray-500">
                        On-page and technical SEO to improve and maximize your website search engine rankings.
                    </p>
                </div>
            </div>
        </div>
